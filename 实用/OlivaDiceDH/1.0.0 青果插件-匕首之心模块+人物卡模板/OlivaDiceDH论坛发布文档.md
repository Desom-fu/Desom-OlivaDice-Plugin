...
- （记得解压！）
[upl-file uuid=待上传 size=待定]ovo-all.zip[/upl-file]
...
- ###### ​**插件包（记得解压！）** ​:
[upl-file uuid=待上传 size=待定]olivadicedh.zip[/upl-file]

- ###### **匕首之心青果专用人物卡模板（解压！）** :
[upl-file uuid=待上传 size=待定]dh.zip[/upl-file]

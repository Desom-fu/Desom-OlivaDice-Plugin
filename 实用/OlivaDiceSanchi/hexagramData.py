...
# 投签用：根据三枚铜钱的阳爻数量（0-3）选择对应的描述
past_identity_dict = {
    0: "[流离失所] - 三阴爻\n布鞋踏碎九州霜雪，兜里仅存半块发霉馒头。墙上的寻人启事墨迹斑驳，倒比族谱更像故乡。\n[身份]：居无定所之人",
    1: "[孤守一方] - 一阳爻\n百年老楼被时光蚀出凹痕，你添灯油的手稳如磐石。灯笼明灭间，风声里总杂着亡者的呢喃。\n[身份]：老旧建筑的看守人",
    2: "[市井乡民] - 二阳爻\n电动车把手上缠着褪色平安符，你熟悉午夜小巷的每一处颠簸。除了保温箱散发香气的麻辣烫，还有街边传出的纸钱烧焦味道。\n[身份]：普通的城镇百姓/打工人",
    3: "[行业翘楚] - 三阳爻\n青瓷胎薄如蛋壳，绣线劈作十六股仍能透光。世人赞你巧夺天工，唯有夜半灯火照见掌心累累灼疤。\n[身份]：专精某一领域的匠人",
}

past_tragedy_dict = {
    0: "[恶鬼缠身] - 三阴爻\n嫁衣女鬼的冰手箍住脚踝，铜镜照不出她形貌，唯见你颈间渐现紫红指痕——像条要勒断头颅的脐带。\n[变故]：被孤魂野鬼纠缠，危及性命。",
    1: "[横遭祸事] - 一阳爻\n暴雨夜货船撞碎在礁群，你攥着浮木漂至荒滩。身后漩涡里沉浮着整船乡亲，眼珠被鱼群啄成空洞。\n[变故]：亲朋好友被异灵迫害。",
    2: "[家族蒙尘] - 二阳爻\n祠堂梁柱突生血泪，族谱姓名逐个溃烂如虫蛀。祖坟深夜传来凿击声，似有百手欲破土拖人陪葬。\n[变故]：家族祠堂突然出现异变。",
    3: "[见证神迹] - 三阳爻\n山崩时裂缝透出七彩幻光，神女残影在云端织补苍穹。待回神时脑中惊现神纹，刻满不属于人间的文字。\n[变故]：偶然之间看见了超越认知的存在。",
}

current_goal_dict = {
    0: "[血海深仇] - 三阴爻\n用坟头土混和异灵心头血捏成偶人，插七寸棺材钉。要那恶鬼也尝尝被剥皮抽筋的痛，永镇酆都刀山底。\n[执念]：向异灵复仇，以牙还牙以血还血",
    1: "[明心证道] - 一阳爻\n迷时但逐浮云影，错认他乡作故园。蓦然撕破千重障，当下踏碎九层关。古寺一声清钟响，万古霜天月正圆。咦！从来明月是我，何须更问西天！\n[执念]：寻觅自身存在的意义。",
    2: "[铲奸除恶] - 二阳爻\n以自身脊骨为鞘锻斩邪刀，专剖食人妖魔肚肠。刀柄缠满受害者发辫，每根都系着未冷的热血。\n[执念]：铲除所有害人的异灵。",
    3: "[生死相托] - 三阳爻\n草蛇灰路引，夜雨浸骨灯，你跪在坟前剖开胸膛，把亡者的执念种进跳动的心脏。\n[执念]：完成亡者的遗愿和嘱托",
}
